  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
           <span style= "color: Blue;">
          <div style="text-align: left;">
     <img src= 'pagina/icon1.png' width='150'>
          </div>
         </span>
       <h5 class="card-title">Agenda</h5>
        <p class="card-text">Cadastre e Gerencie todos os seus compromissos na sua Agenda</p>
        <a href="pagina/agendaList.php" class="btn btn-primary">Ver</a>
        </div>
      </div>
    </div>
      </div>
